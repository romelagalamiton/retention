                                ...
                                <table class="table" id="faculty">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <form action="admin_process.php?id=<?php echo $teacher['id'];?>" method="POST"><input type="submit" class ="btn btn-danger" name="del_acc" onclick="return confirm('Do you want to delete this account?')" value="Delete">  </form></td>
                                            <td>
                                                <a href="" class="btn btn-success">View Class</a>
                                            </td>
