                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <table class="table" id="faculty">
                                    ...
                                    <tbody>
                                        <?php
                                        $get_teacher = mysqli_query($conn, "SELECT * FROM teacher");

                                        while ($teacher = mysqli_fetch_array($get_teacher)) {
                                                $tech_email = $teacher['email'];
                                        ?>
                                            <tr>
                                                <td><?php echo $teacher['id_number']; ?></td>
                                                <td><img src="uploads/<?php echo $teacher['profile']; ?>" class="rounded-circle" style="height: 75px; width:75px;"></td>
                                                <td><?php echo $teacher['firstname']; ?></td>
                                                <td><?php echo $teacher['lastname']; ?></td>
                                                <td><?php echo $teacher['email']; ?></td>

                                                <td>
                                                    <form action="admin_process.php?id=<?php echo $teacher['id']; ?>" method="POST"><input type="submit" class="btn btn-danger" name="del_acc" onclick="return confirm('Do you want to delete this account?')" value="Delete"> </form>
                                                </td>
                                                <td><a href="#" data-bs-toggle="modal" data-bs-target="#class<?php echo $teacher['id'];?>" class="btn btn-success">View Class</a></td>
                                                <div class="modal" id="class<?php echo $teacher['id']; ?>" tabindex="-1">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                    <?php 
                                                                    $get_class = mysqli_query($conn,"SELECT * FROM class WHERE teacher_email = '$tech_email'");
                                                                ...
                                                                ?>
                                                                        <div class="card">
                                                                            <div class="card-body">
                                                                                ...
                                                                                <h5> <?php echo $class['subject_code']; ?></h5>
                                                                            </div>
                                                                        </div>
                                                                        <?php 
                                                                         }
                                ...
                                <script>
                                    let table = new DataTable('#faculty');
                                </script>
                            </div>
                        </div>
                    </div>
